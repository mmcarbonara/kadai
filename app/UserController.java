...
import com.example.samuraitravel.repository.java.UserRepository;
...
public class UserController {
     ...
     public String index(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) {   
    	    /*if (userDetailsImpl == null || userDetailsImpl.getUser() == null) {
    	        // ここでログを出力して、userDetailsImplが正しくないことを確認する
    	        System.out.println("UserDetailsImpl or User is null");
    	        return "redirect:/login"; // またはエラーページにリダイレクト
    	   }  */
